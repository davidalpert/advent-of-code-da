...
module Day16 =
    ...
    open AdventOfCode.ProboscideaVolcanium
    open Xunit
    open FsUnit.Xunit
...
"""
    ...
    [<Fact>]
    let ``2022 - Day 16 - part 1 - example`` () =
        exampleInput
        |> fromInput
        |> Array.length
        |> should equal 1
    ...
    let ``2022 - Day 16 - part 1`` () =
        ...
        // |> fromInput
        // |> Array.length
        |> printfn "2022 - Day 16 - Part 1: %A"

    // [<Fact>]
    let ``2022 - Day 16 - part 2 - example`` () =
        exampleInput
        // |> fromInput
        // |> Array.length
        |> should equal 0
    ...
    // [<Fact>]
    let ``2022 - Day 16 - part 2`` () =
        puzzleInput
        // |> fromInput
        // |> Array.length
        |> printfn "2022 - Day 16 - Part 2: %A"
